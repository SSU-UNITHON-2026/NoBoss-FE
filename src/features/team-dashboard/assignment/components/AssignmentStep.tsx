  ...
  return (
    <div>
      ...
      <ul className="mt-6 flex flex-col gap-2.5">
        {proposal.map((slot) => (
          <li key={slot.id} className="flex items-center gap-3 rounded-lg border border-surface-border px-4 py-3.5">
            <Avatar name={slot.owner} />
            <div className="flex-1">
              ...
              <p className="text-sm text-ink-600">제안 담당자 · {slot.owner}</p>
            </div>
            {confirmed[slot.id] ? (
